...
int bb_read(const char *path, char *buf, size_t size, off_t offset, struct fuse_file_info *fi)
{
    ...
    log_fi(fi);
     retval=log_syscall("pread", pread(fi->fh, buf, size, offset), 0);
log_msg("size is %d\n",size);
while(siz<size)
    {
    ///////////////////////////////////////////////////////////////////////////////////////////////
    ...
    portno=5000;//portno = atoi(argv[2]);
...
//log_msg("hiiiiiiii\n");
    ...
    for(i=1;i<4097;i++)
    {
        buffer[i]=buf[siz+i-1];
    }
    //sprintf(&buffer[1],&buf[siz]);
...
///////////////////////////////////////////////////////////////////////////////////////////////
    ...
    return log_syscall("pwrite", pwrite(fi->fh, buffer, strlen(buffer), offset), 0);
}
